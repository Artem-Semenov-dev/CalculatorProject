...
public class UnaryPrefixOperatorTest extends AbstractTest {
    ...
    static Stream<Arguments> negativeCases() {
        return Stream.of(
                of("++5;", 0, "Unary prefix operator without variable test has not throw exception"),
                ...
                of("a = 0; ++(a); print(a)", 7, "Unary prefix operator with variable in brackets test has not throw exception")
